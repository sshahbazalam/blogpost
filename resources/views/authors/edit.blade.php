            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('authors.update', $author) }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="$author->email" required autocomplete="username" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-textarea name="bio" rows="5" cols="50"  placeholder="Enter your bio here..." :value="$author->bio">
                            {{ $author->bio }}
                        </x-textarea>
